...
/**
 * Created by fineflour on 2/5/2018.
 */
...
public class ServerAuthCodeActivity extends AppCompatActivity implements
    ...
    private void updateUI(@Nullable GoogleSignInAccount account) {
        if (account != null) {
            ((TextView) findViewById(R.id.status)).setText(R.string.action_signin);
            ...
            ((TextView) findViewById(R.id.status)).setText(R.string.action_signout);
